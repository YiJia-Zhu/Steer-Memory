...
Typical usage:
  ...
  - 汇总所有 grid sweep 到一个 CSV：
      - python scripts/summarize_sweep_results.py --all-grids --contains 20260119_000527
      
Optional filtering:
  python scripts/summarize_sweep_results.py --run-name gs_online_math500_deepseek_1p5b --contains 20260119_000527
